...
export function SearchProvider({ children }) {
  ...
  const [searchState, setSearchState] = useState(initialStockDetails)

  const searchStock = async (data) => {
    setSearchState(initialStockDetails)
    setSearchState(await produce(initialStockDetails, async (draft) => {
